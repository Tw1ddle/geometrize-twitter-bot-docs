...
# This script gets the latest changes from the submodule, commits the changes, and pushes to the remote (only if there are any changes, to avoid an infinite build loop)
